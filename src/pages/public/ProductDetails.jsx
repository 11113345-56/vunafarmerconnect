...
function ProductDetails() {
  ...
  async function handleInquirySubmit(event) {
    ...
    try {
     await inquiryService.createInquiry({ product_id: id, farmer_id: product.farmer_id, message: inquiryMessage });
 ...
 const imageUrl = product.image || "https://images.unsplash.com/photo-1560493676-04071c5f467b?auto=format&fit=crop&w=1200&q=80";
  return (
